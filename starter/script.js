...
const restaurant = {
  ...
  orderPasta (ing1, ing2, ing3) {
    console.log( `Here is yours delicious pasta with ${ing1}, ${ing2}, and ${ing3}`
    );
  },
...
// Optional Chaining
  ...
  console.log(restaurant.orderRsotto?.(0, 1) ?? 'methods does not exist');

  // Arrays
  const users = [{ name: 'Jonas', email: 'helllo@jonas.oi'
  }];
...
// Nalish assignment operator (null or undefined)
rest1.numGuests ??= 10;
rest2.numGuests ??= 10;
...
// SPERAD, because on RIGHT side of = 
const arr = [1, 2, ...[3, 4, 5]];
console.log(arr);
...
restaurant.orderPasta('Mushroooms', 'onion', 'olives', 'spinach');
restaurant.orderPasta('Mushroooms');
*/
...
// Object
 ...
 const newRestaurantCopy = {founderIn: 1998, ... restaurant, founder: 'Guiseppe'};
...
const [x, y, z] = arr;
console.log(x, y, z); // DESTRUCTURING
...
console.log(restaurant.order(2, 0)); // 1st way
const [starter, mainCourse] = restaurant.order(2, 0);
console.log(starter, mainCourse); // 2nd way 
